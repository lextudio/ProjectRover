...
using System;
using ILSpyRover.Options;
using ILSpyRover.Providers;
using ILSpyRover.Services;
using ILSpyRover.ViewModels;
using ILSpyRover.Views;
...
namespace ILSpyRover.Extensions;
    ...
    public static IServiceCollection AddHttpClients(this IServiceCollection services)
    {
        ...
        services
            .AddHttpClient<IAutoUpdateService, AutoUpdateService>(httpClient =>
            {
                ...
                httpClient.DefaultRequestHeaders.Add("User-Agent", "ILSpyRover");
            })
